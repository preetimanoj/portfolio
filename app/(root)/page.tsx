...
export default function IndexPage() {
  ...
  return (
    ...
    //   <h1 className="text-4xl font-bold">Preeti Manoj</h1>
    //   <p className="text-xl mt-2">React Frontend Developer</p>

    //   <p className="mt-4 max-w-xl">
    //     Crafting user-friendly, performant React apps with 3 years experience.
    //   </p>
    ...
    //   {/* Contact */}
    //   <p className="mt-8">
    //     Contact me at: <a href="mailto:preeti.email@example.com" className="underline">preeti.email@example.com</a>
    //   </p>
    // </main>
    <ClientPageWrapper>
      <Script
        ...
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
             Building secure, scalable full-stack applications with .NET, React, and a passion for clean code.
            </p>
          </div>
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                href={"https://github.com/preetimanoj"}
                target="_blank"
                className={cn(buttonVariants({ size: "lg" }))}
                aria-label="View Preeti Manoj's GitHub profile"
              >
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Preeti Manoj"
              >
